...
if __name__ == "__main__":
    ...
    parser.add_argument("--expname", help="Experiment name to create new directory under the results", type=str, default="Baseline", choices=["Baseline", "FS", "FS-AE", "FS-DBG-AE"])
